...
resource "aws_iam_role_policy" "s3_access_role" {
...
resource "aws_security_group" "wp_private_sg" {
  name        = "wp_private_sg"
  description = "Used for VPC traffic"
  vpc_id      = "${aws_vpc.wp_vpc.id}"
...
resource "aws_security_group" "wp_rds_sg" {
  name        = "wp_rds_sg"
  description = "Used to access RDS instances"
  vpc_id      = "${aws_vpc.wp_vpc.id}"

  ##### SQL Access from publi/private security groups
